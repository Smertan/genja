...
- Expanded the CLI guide with command examples, task identities, output formats, catalogue usage, discovery architecture and scope, and empty-result and error behaviour. Refs: #125
